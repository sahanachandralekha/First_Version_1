...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "INAI — Adaptive AI Accessibility Companion" },
      { name: "description", content: "A calm accessibility companion that adapts to how you see, hear, and communicate." },
      { name: "author", content: "INAI" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Caveat:wght@500;600&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" },
