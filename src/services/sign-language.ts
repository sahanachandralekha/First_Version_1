...
export const signPhrases: SignPhrase[] = seeds.map(([id, text, category, steps, term]) => ({
  id, text, category, language: "ISL", term,
  reference: { label: "ISLRTC official ISL dictionary", url: referenceUrl(term) },
